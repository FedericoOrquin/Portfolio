        ...
        <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-4'>
          ...
          <div
            ...
            <div className='opacity-0 group-hover:opacity-100 '>
              ...
              <div className='pt-8 text-center'>
                <a href='https://weather-app-fo.netlify.app/' target='_blank' rel="noreferrer">
                  <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg'>
                    Demo
                  </button>
                </a>
                <a href='https://github.com/FedericoOrquin/weather-react-app ' target='_blank' rel="noreferrer">
                  <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg'>
                    Code
                  </button>
                </a>
          ...
          >
            ...
            <div className='opacity-0 group-hover:opacity-100'>
              ...
              <div className='pt-8 text-center'>
                <a href='https://onecocktailapp.netlify.app/' target='_blank' rel="noreferrer">
                  <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg'>
                    Demo
                  </button>
                </a>
                <a href='https://github.com/FedericoOrquin/Cocktail-app' target='_blank' rel="noreferrer">
                  <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg'>
                    Code
                  </button>
                </a>
          ...
          >
            ...
            <div className='opacity-0 group-hover:opacity-100'>
              ...
              <div className='pt-8 text-center'>
                <a href='https://tetris-react-app-fo.netlify.app/' target='_blank' rel="noreferrer">
                  <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg'>
                    Demo
                  </button>
                </a>
                <a href='https://github.com/FedericoOrquin/Tetris-React-app' target='_blank' rel="noreferrer">
                  <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg'>
                    Code
                  </button>
                </a>
